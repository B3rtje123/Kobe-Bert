                ...
                <table class="table-auto w-8/12">
                    ...
                    <tbody>
                        <tr v-for="item in staffResult.getAllStaff" class="odd:bg-black/15">
                            ...
                            <td class="border-r p-2">{{ item.phoneNumber ? item.phoneNumber : "No phone number" }}</td>
                            <td class="border-r p-2">{{ item.role }}</td>
                            <td class="border-r p-2">{{ item.job ? item.job : "No current job" }}</td>
                            <td class="p-2">{{ item.brutoMonthlyWage ? item.brutoMonthlyWage : "No income" }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>  
